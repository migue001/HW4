    ...
    private BottomNavigationView.OnNavigationItemSelectedListener navlis=new BottomNavigationView.OnNavigationItemSelectedListener() {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()){
                case R.id.opcion1:
                    select=new Fragment_Comunicativo_Aprender();
                    break;
                case R.id.opcion22:
                    select=new Fragment_Comunicativo_Asistente();
                    break;
                case R.id.opcion33:
                    select=new Fragment_Comunicativo_Estados();
                    break;
                case R.id.opcion4:
                    select=new Fragment_Comunicativo_DatosApp();
                    break;
                case R.id.opcion5:
